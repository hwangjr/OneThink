...
CREATE TABLE `ad_node` (
  ...
  `node_parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `node_name` varchar(30) NOT NULL DEFAULT '',
  `node_view_name` varchar(30) NOT NULL DEFAULT '',
  `node_level` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `node_descripiton` varchar(255) NOT NULL DEFAULT '',
  `node_display` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `node_order` int(10) unsigned NOT NULL DEFAULT '0',
  `node_createtime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  `node_modifytime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`node_id`)
...
CREATE TABLE `ad_role` (
  ...
  `role_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态，1正常、2删除',
  `role_createtime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  `role_modifytime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`role_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ad_user_login` (
  ...
  `user_login_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '用户登录时间',
  `user_login_ip` varchar(15) NOT NULL DEFAULT '' COMMENT '用户登录IP',
  `user_login_modify_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '信息修改时间',
  `user_login_platform_id` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '第三方平台（0 无平台、 1 腾讯、 2 新浪）',
  `user_login_platform_identifier` varchar(40) NOT NULL DEFAULT '' COMMENT '第三方开放平台用户识别标志',
  `user_login_platform_token` varchar(40) NOT NULL DEFAULT '' COMMENT '第三方token',
  PRIMARY KEY (`uid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
